...
--
-- Table structure for table `m_plofiles`
--

DROP TABLE IF EXISTS `m_plofiles`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `m_plofiles` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `name` varchar(100) NOT NULL COMMENT '???O',
  `kana` varchar(100) NOT NULL COMMENT '?J?i',
  `age` int(11) NOT NULL COMMENT '?N??',
  `prpfile` text NOT NULL COMMENT '?v???t?B?[??',
...
--
-- Dumping data for table `m_plofiles`
--

LOCK TABLES `m_plofiles` WRITE;
/*!40000 ALTER TABLE `m_plofiles` DISABLE KEYS */;
/*!40000 ALTER TABLE `m_plofiles` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-04-17 22:38:33
