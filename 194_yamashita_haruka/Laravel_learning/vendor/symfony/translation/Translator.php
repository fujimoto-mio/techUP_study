...
class Translator implements TranslatorInterface, TranslatorBagInterface, LocaleAwareInterface
{
     ...
     */
<<<<<<<< HEAD:180_kuwahara_yuuhi/p-8/Laravel/Sample/vendor/symfony/translation/Translator.php
    public function addResource(string $format, mixed $resource, string $locale, ?string $domain = null): void
========
    public function addResource(string $format, mixed $resource, string $locale, ?string $domain = null)
>>>>>>>> fc1dae76f6d528b2db14da9bf040759932246f6b:194_yamashita_haruka/Laravel_learning/vendor/symfony/translation/Translator.php
    {
        $domain ??= 'messages';
