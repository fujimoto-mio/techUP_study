                    ...
                    <form action="/tasks" method="post" class="mt-10">
                        ...
                        <div class="flex flex-col items-center">
                            <label class="w-full max-w-3xl mx-auto">
                                <input
                                    class="placeholder:italic placeholder:text-slate-400 block bg-white w-full border border-slate-300 rounded-md py-4 pl-4
                                    shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm"
                                    placeholder="何かをする..." type="text" name="task_name" />
                                    <!-- 送られるデータです -->
                                                ...
                                                <div class="flex justify-end">
                                                    ...
                                                    <div>
                                                        <a href="/tasks/<?php echo e($item->id); ?>/edit/"
                                                            ...
                                                            text-sky-600 md:hover:bg-sky-100 transition-colors">
                                                            編集
                                                        </a>
                                                    </div>
                                                    <div>
                                                        <form onsubmit="return deleteTask();"
                                                            ...
                                                            <button type="submit" class="py-4 w-20 md:hover:bg-slate-200 transition-colors">
                                                                削除
                                                            </button>
                                                        </form>
                                                    </div>
...
</html><?php /**PATH D:\xampp\htdocs\techUP_study\大月凌雅\課題7-6\Sample\resources\views/tasks/index.blade.php ENDPATH**/ ?>