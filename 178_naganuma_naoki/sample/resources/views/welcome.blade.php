    ...
    <head>
        ...
        <style>
            ...
            *, :after, :before { box-sizing: border-box; border: 0 solid #e2e8f0 }
            ...
            svg, video { display: block; } /* vertical-alignを削除 */
            ...
            @media (prefers-color-scheme: dark) { .dark\:bg-gray-800 { --bg-opacity: 1; background-color: #2d3748; background-color: rgba(45, 55, 72, var(--bg-opacity)) } .dark\:bg-gray-900 { --bg-opacity: 1; background-color: #1a202c}}
        </style>
    </head>
</html>