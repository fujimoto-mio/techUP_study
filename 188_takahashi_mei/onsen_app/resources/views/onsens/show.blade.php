<x-app-layout bg="images/washibg.jpg">
    ...
    @if(session('success'))
        <div x-data="{ open: true }" x-show="open"
            ...
            <div class="bg-blue-50 rounded-2xl shadow-xl p-8 w-96 text-center">
                <h2 class="text-lg font-semibold mb-4 text-red-600">投稿完了</h2>

                <p class="mb-6">
                    {{ session('success') }}
                </p>

                <button @click="open = false" class="bg-amber-500 hover:bg-amber-600 text-white px-4 py-2 rounded-lg">
                    OK
                </button>
            </div>
        </div>
    ...
    @if($errors->any())
        <div x-data="{ open: true }" x-show="open"
            class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
            <div class="bg-blue-50 rounded-2xl shadow-xl p-8 w-96 text-center">
                <h2 class="text-lg font-semibold mb-4 text-red-600">投稿できませんでした</h2>
            ...
            <div class="max-w-5xl mx-auto py-10 space-y-10">
                ...
                <div class="grid md:grid-cols-2 gap-8 items-start">
                    ...
                    @if($onsen->images->count())
                        <div class="space-y-4">
                            <div class="swiper overflow-hidden shadow">
